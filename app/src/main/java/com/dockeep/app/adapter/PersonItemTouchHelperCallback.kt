...
class PersonItemTouchHelperCallback(
    private val adapter: DragDropPersonAdapter
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
            ...
            if (viewHolder is DragDropPersonAdapter.PersonViewHolder) {
    ...
    override fun interpolateOutOfBoundsScroll(
        ...
        val direction = kotlin.math.sign(viewSizeOutOfBounds.toFloat()).toInt()
        val outOfBounds = kotlin.math.abs(viewSizeOutOfBounds)
    ...
    private fun performHapticFeedback(view: android.view.View, isStart: Boolean) {
        try {
