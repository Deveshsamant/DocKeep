...
class ImageItemTouchHelperCallback(
    ...
    // Reduce the swipe threshold to make drag more responsive
    ...
    override fun getMovementFlags(
        ...
        // For GridLayoutManager, we need to allow movement in all directions
        ...
        if (viewHolder is ImageAdapter.ImageViewHolder) {
            ...
            viewHolder.cardView.apply {
                animate()
                    ...
                    .scaleX(1.0f)
                    .scaleY(1.0f)
                    .translationZ(6f) // Restore original elevation
                    .setDuration(180)
